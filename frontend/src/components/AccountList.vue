...
const sortedAccounts = computed(() => {
  ...
  sorted.sort((a, b) => {
    ...
    } else if (sortBy.value === 'is_active') {
    ...
    <section id="accounts" class="section">
        ...
        <div v-else class="table-container">
          <div class="section-header">
            <div>
                <h2>Accounts</h2>
                <p>Manage your trading accounts</p>
            </div>
          ...
          <table class="data-table">
            <thead>
              <tr>
                ...
                <th class="sortable-header" @click="handleSort('is_active')">
                  <span>Bot Status</span>
                  <span class="sort-arrow">{{ getSortIcon('is_active') }}</span>
                </th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="status-cell" :class="{ 'status-running': account.is_active, 'status-stopped': !account.is_active }">
                  {{ account.is_active ? 'Running' : 'Stopped' }}
                </td>
...
<style scoped>
  ...
  .status-cell.status-running {
    color: #2e7d32; /* Green for running */
  }

  .status-cell.status-stopped {
    color: #757575; /* Gray for stopped */
  }
